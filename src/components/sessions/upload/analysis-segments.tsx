...
import { Activity, Mic, Plus, X, Edit } from "lucide-react";
import {
  AnalysisSegment,
  AnalysisSegmentsFormData,
...
const AnalysisSegments = ({
  ...
  const [isAddingAnalysis, setIsAddingAnalysis] = React.useState(false);
  ...
  const handleUpdateAnalysis = (
    ...
    console.log("handleUpdateAnalysis", id, analysis);
    onUpdateSegment(id, analysis);
    setEditingSegment?.(null);
  };

  const handleEditSegment = (segment: AnalysisSegment) => {
    posthog.capture("edit_segment_button", {
      segment_id: segment.id,
      segment_type: segment.type,
    });

    // Set the editing segment
